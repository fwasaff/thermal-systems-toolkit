...
def heat_capacity_flow(
    ...
    Examples
    --------
    >>> mass_flow = 5.944  # kg/s (21.4 m³/h, illustrative industrial case)
...
def required_heat_transfer(
    ...
    Examples
    --------
    >>> # Illustrative case: 622 kW demand, 21.4 m³/h flow, ΔT = 25 K
...
def heat_exchanger_area(
    ...
    Examples
    --------
    >>> # Design heat exchanger for an industrial compressor
    >>> Q = 246e3  # W (246 kW)
...
def calculate_heat_transfer_system(
    ...
    Examples
    --------
    >>> # industrial air compressor (e.g. FSD-series)
